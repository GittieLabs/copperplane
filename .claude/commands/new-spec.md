...
4. **Wire the parent link in both directions, in the same operation.** Ask whether this spec has a
...
5. **Report** the new file's path, and explicitly confirm whether a parent link was wired and both
   sides updated.
